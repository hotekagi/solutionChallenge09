...
def convert_webm_to_mp3(webm_file, mp3_file):
    try:
        subprocess.run(["ffmpeg", "-i", webm_file, "-vn", "-acodec", "libmp3lame", mp3_file, "-y"])
...
text_summary = (
    "You are a corrector. "
    "Please read a sentence and correct its typographical errors. "
    "Try to maintain the form of the original sentence as much as possible. "
    "Also, summarize the sentence into three sentences. "
    "The summary should be prepared in English and then translated into the language used for the text before output. "
    "The output is the translated summary only. "
)
